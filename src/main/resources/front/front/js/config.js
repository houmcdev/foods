...
var adminurl = "http://localhost:8080/foods/admin/dist/index.html";
...
var menu = [{
    "backMenu": [{
        ...
        "child": [{
            ...
            "menu": "食堂资讯",
            "tableName": "news"
        }, {"appFrontIcon": "cuIcon-brand", "buttons": ["查看", "修改"], "menu": "轮播图管理", "tableName": "config"}],
        "menu": "系统管理"
    }],
    "frontMenu": [{
        "child": [{
    ...
    "backMenu": [{
        ...
        }, {"appFrontIcon": "cuIcon-phone", "buttons": ["查看", "发货", "物流"], "menu": "已支付订单", "tableName": "orders/已支付"}],
        "menu": "订单管理"
    }],
    "frontMenu": [{
        "child": [{
