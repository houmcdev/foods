<template>
  <div>
    ...
    >  
     <el-row>
      <el-col :span="12">
        <el-form-item   v-if="flag=='shangjia'"  label="商家账号" prop="shangjiabianhao">
          <el-input v-model="ruleForm.shangjiabianhao" readonly              placeholder="商家账号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='peisongyuan'"  label="配送姓名" prop="peisongxingming">
