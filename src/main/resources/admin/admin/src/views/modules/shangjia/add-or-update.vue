      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="商家名称" prop="shangjiamingcheng">
            <el-input v-model="ruleForm.shangjiamingcheng" placeholder="商家名称" clearable
              :readonly="ro.shangjiamingcheng"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="商家地址" prop="shangjiadizhi">
            ...
            <el-select style="width: 100%;" v-model="ruleForm.shangjiadizhi" autocomplete="off" placeholder="请选择商家地址">
              <el-option v-for="(item, index) in shangjiadizhiOptions" v-bind:key="index" :label="item" :value="item">
              </el-option>
            </el-select>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="经营范围" prop="jingyingfanwei">
            ...
            <el-select style="width: 100%;" v-model="ruleForm.jingyingfanwei" autocomplete="off" placeholder="请选择经营范围">
              <el-option v-for="(item, index) in jingyingfanweiOptions" v-bind:key="index" :label="item" :value="item">
              </el-option>
            </el-select>
          </el-form-item>
          <div v-else>
...
export default {
  data() {
    ...
    return {
      ...
      id: '',
      type: '',
      jingyingfanweiOptions: [],
      shangjiadizhiOptions: [],
      ro: {
  ...
  created() {
    ...
    this.jingyingfanweiOptions = "早餐,面食,米饭,烧烤,奶茶".split(',');
    this.shangjiadizhiOptions = "清苑餐厅,莘园餐厅".split(',')
  },
  methods: {
    // 下载
    download(file) {
