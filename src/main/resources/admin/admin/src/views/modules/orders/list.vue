      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt"
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '美食名称' : ''">
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search"
                      v-model="searchForm.goodname" placeholder="美食名称" clearable></el-input>
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search"
                      v-model="searchForm.goodname" placeholder="美食名称" clearable></el-input>
            <el-input v-if="contents.inputIcon == 0" v-model="searchForm.goodname" placeholder="美食名称"
                      clearable></el-input>
          </el-form-item>
          <el-form-item>
        ...
        <el-row class="ad"
          ...
          <el-form-item>
            ...
            >{{ contents.btnAdAllFont == 1 ? '美食销量' : '' }}
            </el-button>
            <el-button
                v-if="isAuth('orders'+'/'+orderStatus,'品销量') && contents.btnAdAllIcon == 1 && contents.btnAdAllIconPosition == 2"
                type="warning"
                @click="goodnameNumberChartDialog()"
            >{{ contents.btnAdAllFont == 1 ? '美食销量' : '' }}<i class="el-icon-s-data el-icon--right"/></el-button>
            <el-button
            ...
            >{{ contents.btnAdAllFont == 1 ? '美食销额' : '' }}
            </el-button>
            <el-button
                v-if="isAuth('orders'+'/'+orderStatus,'品销额') && contents.btnAdAllIcon == 1 && contents.btnAdAllIconPosition == 2"
                type="warning"
                @click="goodnameAmountChartDialog()"
            >{{ contents.btnAdAllFont == 1 ? '美食销额' : '' }}<i class="el-icon-s-data el-icon--right"/></el-button>
            <el-button
          ...
          <el-table-column width="300" :align="contents.tableAlign"
            ...
            <template slot-scope="scope">
              ...
              <el-button v-if="isAuth('orders'+'/'+orderStatus,'物流') && contents.tableBtnIcon == 0" type="primary"
                         size="mini" @click="logisticsUpdate(scope.row.id)">{{ contents.tableBtnFont == 1 ? '物流' : '' }}
              </el-button>
              <el-button
              ...
              <el-button
                  v-if="isAuth('orders'+'/'+orderStatus,'接单') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  type="primary" icon="el-icon-edit" size="mini" @click="updateHandler2(scope.row)">
                {{ contents.tableBtnFont == 1 ? '接单' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('orders'+'/'+orderStatus,'接单') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
                  type="primary" size="mini" @click="updateHandler2(scope.row)">
                {{ contents.tableBtnFont == 1 ? '接单' : '' }}<i class="el-icon-edit el-icon--right"/></el-button>
              <el-button v-if="isAuth('orders'+'/'+orderStatus,'接单') && contents.tableBtnIcon == 0" type="primary"
                         size="mini" @click="updateHandler2(scope.row)">{{ contents.tableBtnFont == 1 ? '接单' : '' }}
              </el-button>
  ...
  data() {
    return {
      ...
      contents: {
        ...
        "tableBtnDelFontColor": "rgba(160, 176, 208, 1)",
        ...
        "tableSelection": true,
        "searchBtnBorderWidth": "0 0 2px 0",
        "tableContentFontSize": "14px",
        "searchBtnBgColor": "rgba(160, 176, 208, 1)",
        "inputTitleSize": "14px",
        "btnAdAllBorderColor": "rgba(160, 176, 208, 1)",
        "pageJumper": true,
        "btnAdAllIconPosition": "1",
        "searchBoxPosition": "1",
        "tableBtnDetailFontColor": "rgba(160, 176, 208, 1)",
        "tableBtnHeight": "40px",
        "pagePager": true,
        "searchBtnBorderColor": "rgba(0, 0, 0, 1)",
        ...
        "pageEachNum": 10,
        "tableHeaderBgColor": "rgba(160, 176, 208, 1)",
        "inputTitleColor": "#333",
        ...
        "inputBgColor": "rgba(160, 176, 208, 1)",
        "pageStyle": true,
        "pageTotal": true,
        ...
        "tableHoverBgColor": "rgba(255, 255, 255, 1)",
        "tableBtnFontSize": "14px",
        "tableBtnBorderColor": "rgba(160, 176, 208, 1)",
        "inputIconPosition": "1",
        "tableBorder": true,
        "btnAdAllBorderStyle": "solid",
        "tableBtnBorderWidth": "3px",
        "tableStripeBgColor": "#F5F7FA",
        "tableBtnEditFontColor": "rgba(160, 176, 208, 1)",
        "tableAlign": "center"
      },
      layouts: '',
