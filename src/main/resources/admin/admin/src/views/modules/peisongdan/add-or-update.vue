  ...
  <div class="addEdit-block">
    <el-form class="detail-form-content" ref="ruleForm" :model="ruleForm" :rules="rules" label-width="80px"
      ...
      <el-row>
        ...
        <el-col :span="24">
          <el-form-item class="upload" v-if="type != 'info' && !ro.tupian" label="图片" prop="tupian">
            <file-upload tip="点击上传美食图片" action="file/upload" :limit="3" :multiple="true"
              :fileUrls="ruleForm.tupian ? ruleForm.tupian : ''" @change="pictureUploadChange"></file-upload>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="配送状态" prop="peisongzhuangtai">
            <el-input v-model="ruleForm.peisongzhuangtai" placeholder="配送状态" clearable
              :readonly="ro.peisongzhuangtai"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="配送状态" prop="peisongzhuangtai">
              <el-input v-model="ruleForm.peisongzhuangtai" placeholder="配送状态" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="用户账号" prop="yonghuzhanghao">
            <el-input v-model="ruleForm.yonghuzhanghao" placeholder="用户账号" clearable
              :readonly="ro.yonghuzhanghao"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="配送账号" prop="peisongzhanghao">
            <el-input v-model="ruleForm.peisongzhanghao" placeholder="配送账号" clearable
              :readonly="ro.peisongzhanghao"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="配送姓名" prop="peisongxingming">
            <el-input v-model="ruleForm.peisongxingming" placeholder="配送姓名" clearable
              :readonly="ro.peisongxingming"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="配送电话" prop="lianxidianhua">
            <el-input v-model="ruleForm.lianxidianhua" placeholder="配送电话" clearable
              :readonly="ro.lianxidianhua"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="配送电话" prop="lianxidianhua">
              <el-input v-model="ruleForm.lianxidianhua" placeholder="配送电话" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="商家账号" prop="shangjiabianhao">
            <el-input v-model="ruleForm.shangjiabianhao" placeholder="商家账号" clearable
              :readonly="ro.shangjiabianhao"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="商家账号" prop="shangjiabianhao">
              <el-input v-model="ruleForm.shangjiabianhao" placeholder="商家账号" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="date" v-if="type!='info'" label="接单时间" prop="qudanshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.qudanshijian" 
                type="datetime"
                :readonly="ro.qudanshijian"
                placeholder="接单时间">
            </el-date-picker>
        </el-form-item>
        <div v-if="type=='info'">
          <el-form-item class="input" label="接单时间" prop="qudanshijian">
              <el-input v-model="ruleForm.qudanshijian"
      ...
      <el-form-item class="btn">
        ...
        <el-button v-if="type == 'info'" class="btn-success" @click="back()" style="color: black">返回</el-button>
      </el-form-item>
    </el-form>
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        goodid: [
          { required: true, message: '美食id不能为空', trigger: 'blur' },
        ],
        goodname: [
        ],
        picture: [
