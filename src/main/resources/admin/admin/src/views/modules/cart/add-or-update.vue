<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="美食表名" prop="tablename">
          <el-input v-model="ruleForm.tablename" 
              placeholder="美食表名" clearable  :readonly="ro.tablename"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="美食表名" prop="tablename">
              <el-input v-model="ruleForm.tablename" 
                placeholder="美食表名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="美食id" prop="goodid">
          <el-input v-model="ruleForm.goodid" 
              placeholder="美食id" clearable  :readonly="ro.goodid"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="美食id" prop="goodid">
              <el-input v-model="ruleForm.goodid" 
                placeholder="美食id" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="美食名称" prop="goodname">
          <el-input v-model="ruleForm.goodname" 
              placeholder="美食名称" clearable  :readonly="ro.goodname"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="美食名称" prop="goodname">
              <el-input v-model="ruleForm.goodname" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="数量" prop="buynumber">
          <el-input v-model="ruleForm.buynumber" 
              placeholder="数量" clearable  :readonly="ro.buynumber"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="数量" prop="buynumber">
              <el-input v-model="ruleForm.buynumber" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="美食类型" prop="goodtype">
          <el-input v-model="ruleForm.goodtype" 
              placeholder="美食类型" clearable  :readonly="ro.goodtype"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="美食类型" prop="goodtype">
              <el-input v-model="ruleForm.goodtype" 
