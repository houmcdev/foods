  ...
  <div class="addEdit-block">
    <el-form class="detail-form-content" ref="ruleForm" :model="ruleForm" :rules="rules" label-width="80px"
      ...
      <el-row>
        ...
        <el-col :span="24">
          <el-form-item class="upload" v-if="type != 'info' && !ro.tupian" label="美食图片" prop="tupian">
          ...
          <div v-else>
            <el-form-item v-if="ruleForm.tupian" label="美食图片" prop="tupian">
        ...
        <el-col :span="24">
          <el-form-item class="textarea" v-if="type != 'info'" label="评价内容" prop="content">
            <el-input style="min-width: 200px; max-width: 600px;" type="textarea" :rows="8" placeholder="评价内容"
              v-model="ruleForm.content" readonly>
            </el-input>
          </el-form-item>
          <div v-else>
            <el-form-item v-if="ruleForm.content" label="评价内容" prop="content">
...
export default {
  ...
  methods: {
    ...
    info(id) {
      this.$http({
        url: `discusscaipinxinxi/info1/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
