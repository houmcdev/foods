<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.picture" label="美食图片" prop="picture">
          <file-upload
          tip="点击上传美食图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.picture" label="美食图片" prop="picture">
      ...
      <el-col :span="12">
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.type-0==1?'在线支付':'现金'"
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.goodtype = true;
            ...
            this.typeOptions = "在线支付,现金".split(',')
            this.statusOptions = "未支付,已支付,已送达,已取消,已退款,配送中".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../foods/upload');
        } else {
