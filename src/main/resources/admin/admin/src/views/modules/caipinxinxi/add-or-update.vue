  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商家账号" prop="shangjiabianhao">
          <el-input v-model="ruleForm.shangjiabianhao" 
              placeholder="商家账号" clearable  :readonly="ro.shangjiabianhao"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-form-item class="btn">
        ...
        <el-button v-if="type=='info'" class="btn-success" @click="back()" style="color: black
        ">返回</el-button>
      </el-form-item>
    </el-form>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.caipinxiangqing = this.ruleForm.caipinxiangqing.replace(reg,'../../../foods/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
