<template>
  <el-breadcrumb class="app-breadcrumb" separator="/" style="height:40px;backgroundColor:rgb(160 176 208);borderRadius:4px;padding:0px 20px 0px 20px;boxShadow:0px 0px 0px rgb(237 168 168);borderWidth:0;borderStyle:dotted solid double dashed;borderColor:#ff0000;">
