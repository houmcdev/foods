...
public class DiscusscaipinxinxiServiceImpl extends ServiceImpl<DiscusscaipinxinxiDao, DiscusscaipinxinxiEntity> implements DiscusscaipinxinxiService {
	...
	public List<HashMap<String,String>> selectList1(Wrapper<DiscusscaipinxinxiEntity> wrapper) {
		return baseMapper.selectList1(wrapper);
	}

	@Override
	public HashMap selectById1(Long id) {
