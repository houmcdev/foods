...
//    	}
    ...
    public R update(@RequestBody OrdersEntity orders, HttpServletRequest request){
        if (orders.getStatus().equals("已送达")){
            CaipinxinxiEntity caipinxinxiEntity = caipinxinxiService.selectById(orders.getGoodid());
            caipinxinxiEntity.setCaipinyueshou(caipinxinxiEntity.getCaipinyueshou()+orders.getBuynumber());
    ...
    public R deleteByid(@RequestBody OrdersEntity ordersEntity){
        ordersService.deleteById(ordersEntity.getId());
        return R.ok();
    }
    /**
     * 提醒接口
...
//            ew.in("status", new String[]{"已支付","配送中","已送达"});
            ew.in("status", new String[]{"已送达"});
