...
//    }
    ...
    public R autoSort2(@RequestParam Map<String, Object> params, CaipinxinxiEntity caipinxinxi, HttpServletRequest request) {
        ...
        //查看用户收藏的电影
        //获得当前登录用户收藏的电影集合 最新收藏的排在最前
        List<StoreupEntity> storeups = storeupService.selectList(new EntityWrapper<StoreupEntity>()
                .eq("userid", userId).setSqlSelect("inteltype")
                .eq("tablename", "caipinxinxi").groupBy("inteltype"));
        ...
        page.setList(caipinxinxiList.subList(0,5));
        return R.ok().put("data", page);
    }
